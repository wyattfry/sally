...
func RegisterRoutes(mux *http.ServeMux, deps Deps) {
	...
	mux.HandleFunc("POST /projects/{projectID}/schedules/reorder", a.reorderSchedules)
	...
	mux.HandleFunc("GET /projects/{projectID}/schedules/{scheduleID}/items/{itemID}/detail", a.showItemDetail)
	...
	mux.HandleFunc("GET /projects/{projectID}/schedules/{scheduleID}/items/{itemID}/image-picker", a.showImagePickerDialog)
	mux.HandleFunc("POST /projects/{projectID}/schedules/{scheduleID}/items/{itemID}/pick-image", a.pickItemImage)
	mux.HandleFunc("POST /projects/{projectID}/schedules/{scheduleID}/items/{itemID}/image", a.selectItemImage)
	...
	mux.HandleFunc("GET /admin/api-tokens", a.adminAPITokens)
	mux.HandleFunc("POST /admin/api-tokens", a.adminCreateAPIToken)
	mux.HandleFunc("POST /admin/api-tokens/{tokenID}/revoke", a.adminRevokeAPIToken)
